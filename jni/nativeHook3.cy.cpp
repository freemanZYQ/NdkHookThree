...
//	void* lib_base = get_base_of_lib_from_maps("/data/app-lib/com.amigo.ndk.target.two-1/libndkTargetTwo.so");
//OR
    void* lib_base = get_base_of_lib_from_soinfo("/data/app-lib/com.amigo.ndk.target.two-1/libndkTargetTwo.so");

	LOGI("lib base is %p",lib_base);
	if (lib_base!=NULL){
		void * getAgeSym = lib_base + 0xd94;
